...
import { Lock, ChevronDown, Check, X } from 'lucide-react'
import { submitScoutApplication } from '@/actions/scout.actions'
...
export default function ScoutApplicationForm({ user }: ScoutApplicationPageProps) {
    ...
    return (
        <div className="min-h-screen bg-[#FAFBFC]">
            ...
            {/* Form */}
            <div className="max-w-[900px] mx-auto px-[48px] py-[48px]">
                {state?.error && (
                ...
                <form action={formAction} className="space-y-[32px]">
                    {/* Section 1: About You */}
                    <div className="bg-white rounded-[4px] border border-[#E5E7EB] shadow-sm p-[48px]">
                    ...
                    {/* Footer */}
                    <div className="fixed bottom-0 left-0 right-0 w-full bg-white border-t border-[#E5E7EB] shadow-md px-[48px] py-[16px] flex justify-between items-center z-10">
                        {isLoggedIn ? (
                            <Link
                                href="/dashboard"
                                className="h-[48px] px-[32px] bg-white border-2 border-[#1B2A4A] text-[#1B2A4A] rounded-full flex items-center justify-center text-[16px] font-medium hover:bg-[#F9FAFB] transition-colors"
                        ...
                        <button
                            type="submit"
                            className="h-[56px] px-[48px] bg-[#0D7377] text-white rounded-full flex items-center justify-center text-[18px] font-medium hover:bg-[#0a5a5d] shadow-md transition-colors"
